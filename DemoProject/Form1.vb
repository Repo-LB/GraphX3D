...
Public Class Form1
    ...
    Dim msh_Cube As MeshObject = MeshObject.FromObjectFile("Cube.obj")
    Dim msh_Cone As MeshObject = MeshObject.FromObjectFile("Cone.obj")
    Dim msh_Sphere As MeshObject = MeshObject.FromObjectFile("Sphere.obj")
